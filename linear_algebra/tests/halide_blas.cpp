...
extern "C"
{
                   ...
                   const int ldc)
  {
    ...
    auto buff_A =
        init_matrix_buffer(tA ? K : M, tA ? M : K, const_cast<float *>(A), lda);
    auto buff_B =
        init_matrix_buffer(tB ? N : K, tB ? K : N, const_cast<float *>(B), ldb);
                   ...
                   const double beta, double *C, const int ldc)
  {
    ...
    auto buff_A =
        init_matrix_buffer(tA ? K : M, tA ? M : K, const_cast<double *>(A), lda);
    auto buff_B =
        init_matrix_buffer(tB ? N : K, tB ? K : N, const_cast<double *>(B), ldb);
    auto buff_C = init_matrix_buffer(M, N, C, ldc);
